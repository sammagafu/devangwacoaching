<template>
  ...
  <section class="relative pt-[140px] pb-[80px] bg-cover" :style="{ backgroundImage: 'url(' + slide0 + ')' }">
    ...
    <div class="container mx-auto -z-50">
      <div class="grid grid-cols-1 pl-40">
        <div class="xl:pt-12 z-[1]">
          ...
          <div class="flex flex-wrap items-center aos-init aos-animate" data-aos="fade-right" data-aos-delay="1400">
            <div class="flex flex-wrap items-center">
              <span class="font-raleway text-black-800 font-bold text-[44px] leading-none">
                <span class="counter is-visible" style="visibility: visible;">1.2</span>k+</span>
            ...
            <div class="mt-5 sm:mt-0">
              <ul class="flex flex-wrap gap-x-4 items-center">
                ...
                <li><a href="#" class="text-black-800 hover:text-orange"><svg width="24" height="24" viewBox="0 0 24 24"
    ...
    <div class="hidden md:block">
      <img
        class="absolute right-10 bottom-0 md:max-w-[420px] lg:max-w-[570px] xl:max-w-[650px] 2xl:max-w-[initial] aos-init aos-animate"
        data-aos="fade-left" src="@/assets/images/hero/hero.png" alt="hero Image">
    </div>
  </section>
</template>
<script setup>
import slide0 from "@/assets/images/branding/2.svg"
</script>
