    ...
    <b-container>
      <b-row class="g-4">
        <b-col lg="3">
          ...
          <p class="my-3">
            Transform your relationships with Devangwa Coaching. Our expert coaches specialize in marriage, workplace, and singles coaching, offering personalized programs to help you build stronger connections, resolve conflicts, and achieve lasting fulfillment.
          </p>
        ...
        <b-col lg="3">
          ...
          <p class="mb-2">
            Toll free:<span class="h6 fw-light ms-2">+255 784 111 111</span>
            <span class="d-block small">(9:AM to 8:PM GMT)</span>
          </p>

          <p class="mb-0">Email:<span class="h6 fw-light ms-2">info@devangwacoaching.com</span></p>
        </b-col>
      </b-row>
      ...
      <div class="py-3">
        <b-container class="px-0">
          <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
            <div class="text-body text-primary-hover"> Copyrights ©{{ currentYear }} Devangwa Coaching. Build by
