            ...
            <b-row class="position-relative">
              ...
              <b-col cols="11" class="mx-auto position-relative">
                <b-row class="align-items-center">
                  <b-col lg="7">
                    <h3 class="text-white">Start Your Journey to a Stronger Relationship</h3>
                    <p class="text-white mb-3 mb-lg-0">Discover the power of connection with Devangwa Coaching. Our self-paced, expert-guided courses empower couples to build trust, resolve conflicts, and nurture lasting love—all from the comfort of home.
                    </p>
                  </b-col>
