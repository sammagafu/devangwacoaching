    ...
    <b-container>
      <b-row class="align-items-center g-5">
        <b-col lg="5" xl="6" class="position-relative z-index-1 text-center text-lg-start mb-7 mb-sm-0">
          ...
          <h1 class="mb-0 display-5">You deserve to live a joyous and  
            <span class="position-relative">meaningful
          ...
          <p class="my-4 lead">Guiding you to unlock your hidden potential with personalized and transformative coaching</p>

          <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
            <li class="list-inline-item me-2">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Gain Clarity
            </li>{{ ' ' }}
            <li class="list-inline-item me-2">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Overcome Overwhelm
            </li>{{ ' ' }}
            <li class="list-inline-item">
              <BIconPatchCheckFill class="h6 me-1 mt-1" />Unlock Your Full Potential for Lasting Transformation.
            </li>
          </ul>
        ...
        <b-col lg="7" xl="6" class="text-center position-relative">
          ...
          <div
            class="p-2 bg-white shadow rounded-3 position-absolute top-50 start-0 translate-middle-y mt-n7 d-none d-sm-block icon">
            <img :src="science" alt="Icon">
          </div>
          <div class="p-2 bg-white shadow rounded-3 position-absolute top-0 end-0 me-5 icon">
            <img :src="angular" alt="Icon">
          </div>
          <div
            class="p-2 bg-white shadow rounded-3 position-absolute top-50 end-0 translate-middle-y mt-5 ms-5 d-none d-lg-block z-index-9 icon">
          ...
          <div
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="text-start ms-3">
                <h6 class="mb-0 text-white">Congratulations <span class="ms-4">
          ...
          <div class="position-relative ms-sm-6">
...
import science from '@/assets/images//element/in-love.png';
import angular from '@/assets/images/element/love-birds.png';
import figma from '@/assets/images/element/love-letter.png';
import element07 from '@/assets/images/element/hero.png';
